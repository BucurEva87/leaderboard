...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n\n  if (!url) {\n    return url;\n  }\n\n  url = String(url.__esModule ? url.default : url); // If url is already wrapped in quotes, remove them\n\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n\n  if (options.hash) {\n    url += options.hash;\n  } // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n\n\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n\n  return url;\n};\n\n//# sourceURL=webpack://boilerplate/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _modules_utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/utils.js */ \"./src/modules/utils.js\");\n/* harmony import */ var _modules_Leaderboard_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/Leaderboard.js */ \"./src/modules/Leaderboard.js\");\n\n\n\n\nconst refreshBtn = _modules_utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].qs('#refresh');\nconst submitBtn = _modules_utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].qs('#submit');\nconst nameError = _modules_utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].qs('.player_name-error');\nconst scoreError = _modules_utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].qs('.player_score-error');\n\nconst checkInputs = (user, score) => {\n  if (!user.length) {\n    nameError.textContent = 'Player name must be at least one alphanumerical character long';\n    nameError.classList.remove('hidden');\n    return false;\n  }\n\n  nameError.textContent = '';\n  nameError.classList.add('hidden');\n\n  if (Number.isNaN(score)) {\n    scoreError.textContent = 'Player score must be a number';\n    scoreError.classList.remove('hidden');\n    return false;\n  }\n  if (score < 0) {\n    scoreError.textContent = 'Player score must be zero or greater';\n    scoreError.classList.remove('hidden');\n    return false;\n  }\n\n  scoreError.textContent = '';\n  scoreError.classList.add('hidden');\n\n  return true;\n};\n\nrefreshBtn.addEventListener('click', () => {\n  'something';\n});\n\nsubmitBtn.addEventListener('click', () => {\n  const user = _modules_utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].qs('#player_name').value.trim();\n  const score = parseInt(_modules_utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].qs('#player_score').value.trim(), 10);\n\n  // Some checks before sending\n  if (!checkInputs(user, score)) return;\n\n  _modules_utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].qs('#player_name').value = '';\n  _modules_utils_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].qs('#player_score').value = '';\n\n  _modules_Leaderboard_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].sendScore(user, score);\n});\n\nrefreshBtn.addEventListener('click', () => {\n  _modules_Leaderboard_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].getScores();\n});\n\n\n//# sourceURL=webpack://boilerplate/./src/index.js?");
...
/***/ "./src/assets/fonts/springtimeromance-lgqqx-webfont.woff":
/*!***************************************************************!*\
  !*** ./src/assets/fonts/springtimeromance-lgqqx-webfont.woff ***!
  \***************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"assets/fonts/springtimeromance-lgqqx-webfont..woff\";\n\n//# sourceURL=webpack://boilerplate/./src/assets/fonts/springtimeromance-lgqqx-webfont.woff?");

/***/ }),

/***/ "./src/assets/fonts/springtimeromance-lgqqx-webfont.woff2":
/*!****************************************************************!*\
  !*** ./src/assets/fonts/springtimeromance-lgqqx-webfont.woff2 ***!
  \****************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"assets/fonts/springtimeromance-lgqqx-webfont..woff2\";\n\n//# sourceURL=webpack://boilerplate/./src/assets/fonts/springtimeromance-lgqqx-webfont.woff2?");
